                ...
                <div className="md:grid md:grid-cols-3 lg:mx-20 sm:mx-4">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-2">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <h2 className="font-fontVollkorn mx-8 self-center text-black text-5xl font-medium mb-4 tracking-wide">International Space Station - ISS</h2>

                            <p className="font-fontVollkorn mx-8 self-center font-medium text-black text-xl text-justify tracking-wide">{t('modelWaterDetails')} This work is based on "International Space Station - ISS - 3D" (https://sketchfab.com/3d-models/international-space-station-iss-3d-a40e6888dcaa4e0297dd27d29e475151) by arnaudbanner (https://sketchfab.com/arnaudbanner) licensed under CC-BY-ND-4.0 (http://creativecommons.org/licenses/by-nd/4.0/)
                            </p>

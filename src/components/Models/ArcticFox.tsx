...
export default function ArticFox() {
            ...
            <div className="pt-8">
                ...
                <div className="md:grid md:grid-cols-3 lg:mx-24 sm:mx-4 md:gap-6">
                    ...
                    <div className="h-full md:col-span-1 lg:block sm:none outline-none">
                        <iframe src="https://go.echoar.xyz/65Rw" title="Earth" className="iframe w-full h-full" />
                    </div>

                    <div className="mt-5 md:mt-0 md:col-span-2">
                        <div className="md:flex md:flex-col md:justify-center ">

                            <h2 className="font-fontVollkorn mx-8 self-center text-white text-5xl font-medium mb-4 tracking-wide">{t('modelArticFoxTitle')}</h2>

                            <p className="font-fontVollkorn mx-8 self-center text-white text-xl text-justify tracking-wide">{t('modelArticFoxDetails')}
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 pb-8 justify-center mx-8 lg:grid-cols-2 gap-6">
                                <img className="flex text-6xl rounded-xl p-6 h-72 w-72" src="https://storage.echoar.xyz/noisy-scene-5023/0aa7dd62-8e0a-4e9a-bdae-4fd0d1827247" alt="Earth QR" />
                                <a href="https://go.echoar.xyz/65Rw" target="_blank" rel="noreferrer">

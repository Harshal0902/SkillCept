                ...
                <div className="md:grid md:grid-cols-3 lg:mx-24 sm:mx-4 md:gap-6">
                    ...
                    <div className="mt-5 md:mt-0 md:col-span-2">
                        <div className="md:flex md:flex-col md:justify-center ">
                            ...
                            <h2 className="font-fontVollkorn mx-8 self-center text-white text-5xl font-bold mb-4 tracking-wide">{t('modelEarthTitle')}</h2>

                            <p className="font-fontVollkorn mx-8 self-center text-white text-xl text-justify tracking-wide">{t('modelEarthDetail')}
                            </p>

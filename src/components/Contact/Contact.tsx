    ...
    return (
        <div style={{ backgroundColor: "#DCE4F7" }} className="pt-24 pb-16">
            ...
            <section className="w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-xl shadow-lg">
                <h2 className="font__title text-5xl font-semibold text-center text-gray-800 ">{t('contactTilte')}</h2>
                ...
                <form action="https://formspree.io/f/xbjqarrq" method="POST" >
                    <div className="items-center -mx-2 md:flex">
                        <div className="w-full mx-2 mt-4 md:mt-0">
                            <label className="text__font block mb-2 text-lg font-medium text-gray-600 dark:text-gray-200">{t('contactFormName')}</label>
                        ...
                        <div className="w-full mx-2 mt-4 md:mt-0">
                            <label className="text__font block mb-2 text-lg font-medium text-gray-600 dark:text-gray-200">{t('contactFormEMail')}</label>
                    ...
                    <div className="w-full mt-4">
                        <label className="text__font block mb-2 text-lg font-medium text-gray-600 dark:text-gray-200">{t('contactFormMessage')}</label>
                    ...
                    <div className="flex justify-center mt-6">
                        <button type="submit" id="formBtn" className="text__font px-4 py-2 text-white transition-colors duration-200 transform bg-blue-700 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-gray-600 text-lg shadow-lg">{t('contactFormSendMessage')}</button>
                    </div>

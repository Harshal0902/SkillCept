  ...
  return (
    <div className="pt-8 md:pt-16 min-h-screen text-white">
      ...
      <motion.div variants={fadeBottom} initial="hidden" animate="visible" className="flex flex-wrap flex-col-2 justify-around w-full px-16">
        ...
        <Link href="/subject/biology/skull" passHref>
          <motion.div variants={fadeItem} className="m-8">
            <div className="w-72 h-72 cursor-pointer transition duration-500 transform hover:scale-105">
              ...
              <div className="grid -mt-9 place-content-center mx-1 text-xl">{t.HumanSkull}</div>
            </div>
          </motion.div>
        </Link>
        ...
        <motion.div variants={fadeItem} className="m-8">
          <div className="w-72 h-52 border-4 border-secondary rounded-lg">
            <div className="grid place-content-center text-3xl text-center items-center align-middle h-full font-semibold ">{t.biologyMore}</div>
          </div>
        </motion.div>

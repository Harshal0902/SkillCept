...
export default function SpaceSubject() {
    ...
    const subject = spacePageInfo.find((item) => item.SpaceSubject === spaceSubject);
                    ...
                    <div className="mt-16 md:mt-0 md:col-span-1 p-4">
                        <div className="h-full md:flex md:flex-col md:justify-center">
                            ...
                            <div className="grid place-items-center pb-8 mx-8">
                                <Image src={`/space/${subject.QrCodeUrl}`} width="250" height="250" alt="Space QR" className="flex p-6 text-6xl rounded-xl h-48 w-48" />

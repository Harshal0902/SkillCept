...
**1.**  Fork [this](https://github.com/Harshal0902/SkillCept) repository.

**2.**  Clone your forked copy of the project.

```
git clone --depth 1 https://github.com/<your_user_name>/SkillCept.git
```
...
```
git remote add upstream https://github.com/Harshal0902/SkillCept.git 
```
